<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="courses.aspx.vb" Inherits="LearnerManagementSystem.Courses" %>
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="discussions.aspx">View discussion topics</a></li>
              </ul>
            </li>
            <li class="dropdown">
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><a href="#" class="btn btn-primary disabled">Resume</a></td>
                          </tr>
                          <tr>
                            <td>
                              003
                            </td>
                            <td>Fuel Water Seperator Tank</td>
                            <td class="align-middle">
                              <div class="progress progress-xs">
                          ...
                          <tr>
                            ...
                            <td><a href="#" class="btn btn-primary">Resume</a></td>
                          </tr>
                          <tr>
                            <td>
                              006
                            ...
                            <td class="align-middle">
                              <div class="progress progress-xs">
                                <div class="progress-bar bg-success width-per-100"></div>
                              </div>
                            </td>
                            <td>
                              <img alt="image" src="assets/img/users/user-2.png" width="35">
