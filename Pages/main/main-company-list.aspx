<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="main-company-list.aspx.vb" Inherits="LearnerManagementSystem.main_company_list" %>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 id="lblCategory" runat="server">Institutions</h4>
                      <div class="card-header-action text-right">
                          ...
                          <a href="main-company-add.aspx" class="btn btn-sm btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Add Institution</a>
                      </div>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvCompanies" runat="server" 
                            ...
                            EmptyDataText="No Institutions Available."
                            Width="100%"
                            ...
                            OnRowDataBound="gvCompanies_RowDataBound"
