<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin.Master" CodeBehind="admin-category-list.aspx.vb" Inherits="LearnerManagementSystem.admin_category_list" %>
                  ...
                  <div class="card-header">
                    <h4 id="lblCategory" runat="server">Categories</h4>
                      <div class="card-header-action text-right">
                          ...
                          <a href="admin-category-add.aspx" class="btn btn-sm btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Add Category</a>
                      </div>
                  </div>
                  <div class="card-body">
