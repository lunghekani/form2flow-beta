<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin.Master" CodeBehind="test.aspx.vb" Inherits="LearnerManagementSystem.test" %>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3 col-6">
                                                    ...
                                                    <%--<asp:Button ID="btnSubmitScreen1" CssClass="btn btn-primary btn-lg btn-block" Text="Next" runat="server" OnClick="btnSubmitScreen1_Click" TabIndex="4"></asp:Button>--%>
                                                    <asp:Button runat="server" ID="i" OnClientClick="btnSubmitScreen1_Click" Text ="fuck"/>
                                                    <%--<button type="button" id="btnSubmitScreen1" runat="server" class="btn btn-primary btn-lg btn-block" onserverclick="btnSubmitScreen1_Click" tabindex="4">Next</button>--%>
                                                    <button type="button" id="btnToScreen2" runat="server" class="btn btn-primary btn-lg btn-block" onserverclick="btnToScreen2_Click" tabindex="4">Next</button>
                                                </div>
                                            </div>
