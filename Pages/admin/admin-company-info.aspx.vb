...
Public Class admin_company_info
...
#Region "Navigational Buttons"
    ...
    Protected Sub btnYesRegional_Click(sender As Object, e As EventArgs)

    End Sub

    Protected Sub btnNoRegional_ServerClick(sender As Object, e As EventArgs)
