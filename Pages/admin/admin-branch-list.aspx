<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin.Master" CodeBehind="admin-branch-list.aspx.vb" Inherits="LearnerManagementSystem.admin_branch_list" %>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 id="lblCategory" runat="server">Branches</h4>
                      <div class="card-header-action text-right">
                          ...
                          <a href="admin-branch-add.aspx" class="btn btn-sm btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Add Branch</a>
                      </div>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvBranches" runat="server" 
                            ...
                            OnPageIndexChanging="gvBranches_PageIndexChanging"
