<%@ Page Title="Admin - Company Information" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin.Master" CodeBehind="admin-company-info.aspx.vb" Inherits="LearnerManagementSystem.admin_company_info" %>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3 col-6">
                                                        ...
                                                        <button type="button" id="btnToScreen2" runat="server" class="btn btn-primary cancel btn-lg btn-block" onserverclick="btnToScreen2_Click" tabindex="4" visible="false">Submit</button>
                                                    </div>
                                                </div>
                                    ...
                                    <asp:View ID="viewContactDetails" runat="server">
                                        <div class="card card-primary">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-3 offset-md-6 col-6">
                                                        <button type="button" id="btnBackToScreen1" runat="server" class="btn btn-secondary cancel btn-lg btn-block" onserverclick="btnCancel_ServerClick" tabindex="4">Update</button>
                                                    </div>
                                                    <div class="form-group col-md-3 col-6">
                                                        ...
                                                        <button type="button" id="btnToScreen3" runat="server" class="btn btn-primary cancel btn-lg btn-block" onserverclick="btnToScreen3_Click" tabindex="4" visible="false">Submit</button>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3 col-6">
                                                        ...
                                                        <button type="button" id="btnToScreen4" runat="server" class="btn btn-primary cancel btn-lg btn-block" onserverclick="btnToScreen4_Click" tabindex="4" visible="false">Submit</button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card card-primary">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row" align="center">
                                                    <div class="form-group col-md-12 col-12">
                                                        <h5>Does the Head Office have Regional Offices?</h5>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-3 offset-md-6 col-6">
                                                        <button type="button" id="btnNoRegional" runat="server" class="btn btn-secondary cancel btn-lg btn-block" onserverclick="btnNoRegional_ServerClick" tabindex="4">No</button>
                                                    </div>
                                                    <div class="form-group col-md-3 col-6">
                                                        <asp:Button ID="btnYesRegional" CssClass="btn btn-primary btn-lg btn-block" Text="Yes" runat="server" OnClick="btnYesRegional_Click" TabIndex="4"></asp:Button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
