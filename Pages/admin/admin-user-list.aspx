<%@ Page Title="User List" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin.Master" CodeBehind="admin-user-list.aspx.vb" Inherits="LearnerManagementSystem.admin_user_list" %>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 id="lblUser" runat="server">All Users</h4>
                                            ...
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Button id="btnView" CommandName="View" runat="server" Text="View" CssClass="btn btn-primary btn-block valid" UseSubmitBehavior="false" CommandArgument="<%# Container.DataItemIndex %>" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
