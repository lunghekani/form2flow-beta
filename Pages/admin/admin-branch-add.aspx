<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin.Master" CodeBehind="admin-branch-add.aspx.vb" Inherits="LearnerManagementSystem.admin_branch_add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form runat="server" class="needs-validation" novalidate="">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-4 col-12">
                                                        ...
                                                        <div class="invalid-feedback">
                                                            Please fill in your branch name
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-4 col-12">
                                                        <label for="number">Company Reg No.</label>
                                                        <input id="txtCompRegNum" runat="server" type="text" class="form-control" name="companyRegNum" tabindex="1" maxlength="20">
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="form-group col-md-4 col-12">
                                                        ...
                                                        <input id="txtCompVATNum" runat="server" type="text" class="form-control" name="vatNum" tabindex="1" maxlength="20">
                                                        <div class="invalid-feedback">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6 col-12">
                                                        ...
                                                        <asp:FileUpload ID="upTaxClearCert" runat="server" type="file" class="form-control"/>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6 col-12">
                                                        ...
                                                        <asp:FileUpload ID="upBEECert" runat="server" type="file" class="form-control"/>
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="form-group col-md-6 col-12">
                                                        ...
                                                        <asp:FileUpload ID="upHealthCert" runat="server" type="file" class="form-control" required=""/>
                                                        <div class="invalid-feedback">
                                    ...
                                    <asp:View ID="viewIsThereRegionalOffices" runat="server">
                                        <div class="card card-primary">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-3 offset-md-6 col-6">
                                                        <button type="button" id="btnDashboard" runat="server" class="btn btn-secondary cancel btn-lg btn-block" onserverclick="btnDashboard_ServerClick" tabindex="4">Dashboard</button>
                                                    </div>
                                                    <div class="form-group col-md-3 col-6">
         ...
         <script> 
            ...
            $("#<%=ddlDepartments.ClientID%>").select2();
        }
         </script>
    ...
    <script type="text/javascript">  
        var x = document.getElementById("#<%=getGPS.ClientID%>");
        ...
        function showPosition(position) {
            ...
            //alert(latlondata);
            document.getElementById("#<%=txtGPS.ClientID%>").value = latlondata;
