<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin.Master" CodeBehind="admin-course-list.aspx.vb" Inherits="LearnerManagementSystem.admin_course_list" %>
                  ...
                  <div class="card-header">
                    <h4 id="lblCategory" runat="server">Courses</h4>
                      <div class="card-header-action text-right">
                          ...
                          <a href="admin-course-add.aspx" class="btn btn-sm btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Add Course</a>
                      </div>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvCourses" runat="server" 
                            ...
                            <Columns >
                                ...
                                <asp:BoundField DataField="CourseTimeLimit" HeaderText="Duration" />
                                <asp:BoundField DataField="NQFLevel" HeaderText="NQF Level" />
                                <asp:BoundField DataField="Disabled" HeaderText="Status" />
