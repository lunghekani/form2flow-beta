                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <asp:MultiView ID="mvRegisterCompany" runat="server">
                                ...
                                <asp:View ID="viewContactDetails" runat="server">
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <asp:UpdatePanel ID="PanelCompanyTour" runat="server">
                                                <ContentTemplate>
                                                    <!-- Virtual Reality Grid View -->
                                                    <div class="clearfix mb-3"></div>
                                                    <div class="table-responsive">
                                                        <asp:GridView ID="gvCompanyTour" runat="server"
                                                            ...
                                                            OnPageIndexChanging="gvCompanyTour_PageIndexChanging"
                                                            OnRowCommand="gvCompanyTour_RowCommand"
                                                            OnRowDataBound="gvCompanyTour_RowDataBound"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:Button CommandName="Remove" runat="server" Text="Remove" CssClass="btn btn-danger btn-block valid" UseSubmitBehavior="false" CommandArgument="<%# Container.DataItemIndex %>" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                            ...
                                            <div class="row">
                                                        <div class="form-group col-md-12 col-12">
                                                            ...
                                                            <asp:FileUpload ID="upCompanyTour" runat="server" type="file" class="form-control" AllowMultiple="true" />
                                                            <div class="invalid-feedback">
                                                        ...
                                                        <%--<div class="col-sm-1 col-md-1 col-1">
                                                            <label style="color: white;">Category</label>
                                                            <button type="button" class="btn btn-icon btn-primary" runat="server" id="btnDownloadCompTourFiles" onserverclick="btnDownloadCompTourFiles_ServerClick"><i class="fas fa-download"></i></button>
                                                            <div class="invalid-feedback">
                                                                Please select document type
                                                            </div>
                                                        </div>--%>
                                ...
                                <!-- Screeen 4 - Other Company details Continued -->
                                <asp:View ID="viewOtherDetailsCont" runat="server">
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-12">
                                                    ...
                                                    <textarea id="txtRegionalOfficeDescription" runat="server"
                                                        class="form-control" placeholder="Please describe your office" maxlength="255" required></textarea>
                                                    <div class="invalid-feedback">
                                            ...
                                            <!-- Company Logo -->
                                            <div class="row">
                                                <div class="form-group col-md-11 col-11">
                                                    <label for="email">Company Logo</label>
                                                    <asp:FileUpload ID="upCompanyLogo" runat="server" type="file" class="form-control" required="" />
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-sm-1 col-md-1 col-1">
                                                    <label style="color: white;">Category</label>
                                                    <button type="button" class="btn btn-icon btn-primary" runat="server" id="btnDownloadCompLogo" onserverclick="btnDownloadCompLogo_ServerClick"><i class="fas fa-download"></i></button>
                                                    <div class="invalid-feedback">
                                                        Please select document type
                                                    </div>
                                                </div>
