<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DocumentPortal.aspx.vb" Inherits="DocumentManagementSystem.DocumentPortal" %>
...
<head>
  ...
  <link rel='shortcut icon' type='image/x-icon' href='assets/img/red.ico' />
    ...
    <style type="text/css">
        ...
        th, td {
            /* Removed the width to allow for the gridview to fit in Mobile View*/
            /*width:150px;*/
            text-align: center;
        ...
        .GridPager span
        {
            ...
            color: #fff;
            border: 1px solid #6777ef; /*#3AC0F2*/
        }
...
<li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title" runat="server" id="lblFullName">Hello</div>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="assets/img/red_erp.jpg" class="header-logo" /> <span
                class="logo-name"></span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
              <li class="dropdown" runat="server" id="liDocPortal">
              <a href="DocumentPortal.aspx" class="nav-link"><i data-feather="monitor"></i><span>Document Portal</span></a>
            </li>
            <li class="dropdown" runat="server" id="liReqPortal">
              <a href="RequestPortal.aspx" class="nav-link"><i data-feather="edit"></i><span>Request Portal</span></a>
            </li>
              <li class="dropdown" runat="server" id="liNewDoc">
              <a href="NewDocument.aspx" class="nav-link"><i data-feather="plus"></i><span>Create New Document</span></a>
            </li>
            <%--<li class="dropdown">
        ...
        <section class="section">
             <!-- Page Heading -->
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">docXview</h1>
                    <%--<a href="#" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fas fa-edit fa-sm text-white-50"></i> Request Change</a>
                    <a href="NewDocument.aspx" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Create New Document</a>--%>
                </div>
            <!-- Page Heading -->
                ...
                <div class="card mb-0">
                  <div class="card-body">
                    <ul class="nav nav-pills">
                      <li class="nav-item">
                        <a class="nav-link active" id="btnAllDocs" runat="server" onserverclick="btnAllDocs_ServerClick">All <span class="badge badge-info" id="spAll" runat="server"></span></a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="btnApprovedDocs" runat="server" onserverclick="btnApprovedDocs_ServerClick">Approved <span class="badge badge-success" id="spApproved" runat="server"></span></a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="btnPendingDocs" runat="server" onserverclick="btnPendingDocs_ServerClick" >Pending Raised by Me <span class="badge badge-warning" id="spPending" runat="server"></span></a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="btnWithdrawnDocs" runat="server" onserverclick="btnWithdrawnDocs_ServerClick">Withdrawn Raised by Me <span class="badge badge-danger" id="spWithdrawn" runat="server"></span></a>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 id="lblDoc" runat="server">All Documents</h4>
                      <div class="card-header-action text-right">
                          ...
                          <a href="NewDocument.aspx" class="btn btn-sm btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Create New Document</a>
                      </div>
                  </div>
                  <div class="card-body">
                            ...
                            <Columns >
                                <asp:TemplateField >
                                    <ItemTemplate>
                                        ...
                                        <asp:Button CommandName="AuditDocument" runat="server" Text="Audit Document" CssClass="btn btn-warning btn-block" UseSubmitBehavior="false" CommandArgument="<%# Container.DataItemIndex %>" />
                                        <asp:Button CommandName="AuditTemplate" runat="server" Text="Audit Template" CssClass="btn btn-info btn-block" UseSubmitBehavior="false" CommandArgument="<%# Container.DataItemIndex %>" />
                                        <!-- <asp:Button CommandName="AuditResult" runat="server" Text="Audit Results" CssClass="btn btn-success btn-block" UseSubmitBehavior="false" CommandArgument="<%# Container.DataItemIndex %>" /> -->
                                ...
                                <asp:BoundField DataField="Description" HeaderText="Description" ControlStyle-CssClass="max-texts"/>
                                <asp:BoundField DataField="Type" HeaderText="Type"/>
                                <asp:BoundField DataField="Category" HeaderText="Category"/>
                                <asp:BoundField DataField="Status" HeaderText="Status"/>
                                <asp:BoundField DataField="Issued Date" HeaderText="Issued Date"/>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="myLargeModalLabel">Request a Change</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-12 col-12">
                                    ...
                                    <asp:DropDownList ID="ddlReqChangeDoc" runat="server" CssClass="form-control select2" Width="100%" required="">
                                        <asp:ListItem>Policy</asp:ListItem>
                                        <asp:ListItem>Procedure</asp:ListItem>
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <textarea id="txtReqChangeDesc" runat="server"
                                        class="form-control" placeholder="What changes do you want?" required></textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <asp:FileUpload ID="upReqChangeFile" runat="server" type="file" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="card-body text-right">
                                    <asp:button ID="btnSubmitRequest" CssClass="btn btn-primary" runat="server" OnClick="btnSubmitRequest_Click" Text="Submit" ></asp:button>
