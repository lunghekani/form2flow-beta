<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="course-list.aspx.vb" Inherits="LearnerManagementSystem.course_list" %>
                  ...
                  <div class="card-header">
                    <h4 id="lblCategory" runat="server">Courses</h4>
                      <div class="card-header-action text-right">
                          ...
                          <a href="category-add.aspx" class="btn btn-sm btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Add Course</a>
                      </div>
                  </div>
                  <div class="card-body">
