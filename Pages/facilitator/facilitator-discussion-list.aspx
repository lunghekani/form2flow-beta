<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Facilitator.Master" CodeBehind="facilitator-discussion-list.aspx.vb" Inherits="LearnerManagementSystem.facilitator_discussion_list" %>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 id="lblCategory" runat="server">Discussions</h4>
                      <div class="card-header-action text-right">
                          ...
                          <a href="facilitator-discussion-add.aspx" class="btn btn-sm btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Add Topic</a>
                      </div>
                  </div>
                  <div class="card-body">
