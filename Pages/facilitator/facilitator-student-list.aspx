<%@ Page Title="Student List" Language="vb" AutoEventWireup="false" MasterPageFile="~/Facilitator.Master" CodeBehind="facilitator-student-list.aspx.vb" Inherits="LearnerManagementSystem.facilitator_student_list" %>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 id="lblUser" runat="server">Students</h4>
                                    <div class="card-header-action text-right">
                                        ...
                                        <a href="../auth/register-user.aspx" class="btn btn-sm btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i>Add Student</a>
                                    </div>
                                </div>
                                <div class="card-body">
                            ...
                            <button class="btn btn-primary"><i class="fas fa-search"></i></button>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvStudents" runat="server"
                                            ...
                                            EmptyDataText="No Students Available."
                                            Width="100%"
