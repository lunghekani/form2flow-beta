<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Facilitator.Master" CodeBehind="facilitator-category-list.aspx.vb" Inherits="LearnerManagementSystem.facilitator_category_list" %>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 id="lblCategory" runat="server">Categories</h4>
                      <div class="card-header-action text-right">
                          ...
                          <a href="facilitator-category-add.aspx" class="btn btn-sm btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Add Category</a>
                      </div>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvCategories" runat="server" 
                            ...
                            <Columns >
                                <asp:TemplateField >
                                    <ItemTemplate>
                                        <asp:Button CommandName="Edit" runat="server" Text="Edit" ItemStyle-HorizontalAlign="Center" Width="50%" CssClass="btn btn-warning btn-block valid" UseSubmitBehavior="false" CommandArgument="<%# Container.DataItemIndex %>"  />
                                        <asp:Button CommandName="Delete" runat="server" Text="Delete" ItemStyle-HorizontalAlign="Center" Width="50%" CssClass="btn btn-danger btn-block valid" UseSubmitBehavior="false" CommandArgument="<%# Container.DataItemIndex %>" />
                                    </ItemTemplate>
                                </asp:TemplateField>
