<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Facilitator.Master" CodeBehind="facilitator-appeal-info.aspx.vb" Inherits="LearnerManagementSystem.facilitator_appeal_info" %>
                                             ...
                                             <div class="row">
                                                 <div class="col justify-content-aroundW" align="right">
                                                     <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                                        <asp:Button ID="btnBack" CssClass="btn btn-primary btn-lg btn-block" Text="Return" runat="server" OnClick="BtnBack_Click"></asp:Button>  
                                                     </div>
                                                 </div>                                           
                                             </div>
                                            </div>
