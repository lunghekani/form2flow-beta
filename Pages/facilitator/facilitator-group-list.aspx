<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Facilitator.Master" CodeBehind="facilitator-group-list.aspx.vb" Inherits="LearnerManagementSystem.facilitator_group_list" %>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 id="lblGroup" runat="server">Groups</h4>
                      <div class="card-header-action text-right">
                          ...
                          <a href="facilitator-group-add.aspx" class="btn btn-sm btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Add Group</a>
                      </div>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvGroups" runat="server" 
                            ...
                            EmptyDataText="No Groups Available."
                            Width="100%"
