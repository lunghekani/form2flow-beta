<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Facilitator.Master" CodeBehind="facilitator-appeal-list.aspx.vb" Inherits="LearnerManagementSystem.facilitator_appeal_list" %>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 id="lblCategory" runat="server">Appeals</h4>
                      <div class="card-header-action text-right">
                          ...
                          <%--<a href="admin--add.aspx" class="btn btn-sm btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Add Appeal</a>--%>
                      </div>
                  </div>
                  <div class="card-body">
